...
export default function SettingsPage() {
  ...
  if (!user) {
    return (
      <div className="container py-10">
        <div className="rounded-xl border bg-white p-6 text-center shadow-sm">
          <p className="text-sm text-slate-600">Hesap ayarları için giriş yapmalısınız. Yönlendiriliyorsunuz...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container py-10 space-y-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="text-sm font-semibold text-blue-600">Profil & Güvenlik</p>
        ...
        <div className="flex items-center gap-2 self-start rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-semibold shadow-sm">
          <span className="rounded-full bg-slate-100 px-2 py-0.5 text-xs text-slate-700">Plan</span>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          <form onSubmit={handleProfileSave} className="space-y-4 rounded-xl border bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-slate-700">Profil bilgileri</p>
                <p className="text-xs text-slate-500">Ad-soyadınızı güncelleyin, email sabittir.</p>
              </div>
          ...
          <form onSubmit={handlePasswordSave} className="space-y-4 rounded-xl border bg-white p-6 shadow-sm">
            <div className="space-y-1">
              <p className="text-sm font-semibold text-slate-700">Şifre ve güvenlik</p>
              <p className="text-xs text-slate-500">Güçlü bir şifre belirleyin. Şifre değişimi için mevcut şifrenizi doğruluyoruz.</p>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500">
              <span className="rounded-full bg-slate-100 px-2 py-1">Min 8 karakter</span>
              <span className="rounded-full bg-slate-100 px-2 py-1">Email değişmez</span>
            </div>
            <button
              type="submit"
              ...
              disabled={savingPassword}
            >
              {savingPassword ? "Şifre güncelleniyor..." : "Şifremi güncelle"}
            </button>
        ...
        <div className="space-y-4">
          <div className="space-y-3 rounded-xl border bg-white p-6 shadow-sm">
            <p className="text-sm font-semibold text-slate-700">Paket & kullanım</p>
            <div className="rounded-lg border border-slate-100 bg-slate-50 px-4 py-3">
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 text-xs text-slate-600">
                ...
                <span className="text-right">{dailyLimit ?? "Sınırsız"}</span>
                <span>Bugün kullanılan</span>
                <span className="text-right">{dailyUsed}</span>
                <span>Kalan</span>
                <span className="text-right">{dailyRemaining ?? "Sınırsız"}</span>
                <span>Aylık kullanım</span>
                <span className="text-right">{monthlyUsage ?? "-"} adet</span>
              </div>
            </div>
            <div className="rounded-lg border border-amber-100 bg-amber-50 px-4 py-3 text-sm text-amber-800">
              <p className="font-semibold">Güvenlik hatırlatması</p>
          ...
          <div className="rounded-xl border bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700 p-6 text-white shadow-sm">
            <p className="text-sm font-semibold text-blue-100">API anahtarı</p>
